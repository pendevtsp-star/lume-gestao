...
META_CONFIGURATION_ID = config("META_CONFIGURATION_ID", default="")
WHATSAPP_EMBEDDED_APP_ID = config("WHATSAPP_EMBEDDED_APP_ID", default=META_APP_ID)
WHATSAPP_EMBEDDED_CONFIG_ID = config("WHATSAPP_EMBEDDED_CONFIG_ID", default=META_CONFIGURATION_ID)
WHATSAPP_EMBEDDED_APP_SECRET = config("WHATSAPP_EMBEDDED_APP_SECRET", default=META_APP_SECRET)
