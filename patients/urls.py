...
urlpatterns = [
    ...
    path("indicacoes/", ReferralListView.as_view(), name="referrals"),
    path("indicacoes/<int:pk>/", ReferralUpdateView.as_view(), name="referral_update"),
    path("indique/<str:code>/", ReferralPublicCreateView.as_view(), name="referral_public"),
